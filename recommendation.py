...
KPI_OUTPUT_PATH = Path("/mnt/input/kpi_output.json")
INVESTIGATION_PATH = Path("/mnt/input/investigation_output_5.json")
UNSTRUCTURED_EVIDENCE_PATH = Path("/mnt/input/unstructured_evidence.json")

OUTPUT_PATH = Path("/mnt/output/recommendation_output_5.json")
@app.function(
    image=image,
    gpu="A100",
    volumes={"/mnt": volume},
