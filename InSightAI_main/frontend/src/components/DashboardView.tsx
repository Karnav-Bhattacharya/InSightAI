...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  const categories = useMemo(() => {
    ...
    return [
      'All',
      'High Priority',
      ...uniqueRoleCategories
    ];

  }, [insights]);


  /* Reset filter when insights change */
  ...
  return (
    ...
    <div className="w-full flex-1 flex flex-col items-center justify-between px-4 sm:px-10 py-8 relative text-[#273444]">
      ...
      >
        ...
        <span>
          © 2024 InSightAI Global Logistics
        </span>
